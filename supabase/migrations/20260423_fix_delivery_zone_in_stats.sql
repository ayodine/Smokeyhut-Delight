-- supabase/migrations/20260423_fix_delivery_zone_in_stats.sql
-- Re-apply corrected get_product_stats_lists after migration ordering issue.
-- Uses delivery_zone column (added by 20260422100000) with address-parse fallback.
